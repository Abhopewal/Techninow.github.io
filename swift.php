  ...
  <main role="main" class="container">
    <div class="row">
      <div class="col-md-8 blog-main" style="border: .5px dotted rgb(230, 226, 226); background-color: rgb(255, 255, 255); margin-top: 20px;">
        ...
        <div class="blog-post">
          <h2 class="blog-post-title" style="text-align: center;">Swift-Home</h2>
      ...
      <aside class="col-md-4 blog-sidebar" >
        <div class="p-4" style="border: .5px dotted rgb(235, 227, 227); background-color: rgb(255, 254, 254); margin-top: 20px;">
          ...
          <h4 class="font-italic">Swift Basic Tutorials</h4>
          <ol class="list-unstyled mb-0" >
            <li><a href="#">Swift-Home</a></li>
            <li><a href="#">Swift-Overview</a></li>
            <li><a href="#">Swift-setup</a></li>
            <li><a href="#">Swift-syntax</a></li>
            <li><a href="#">Swift-variable types</a></li>
            <li><a href="#">Swift-Basic operator</a></li>
            <li><a href="#">Swift-Decision making</a></li>
            <li><a href="#">Swift-Loops</a></li>
            <li><a href="#">Swift-Numbers</a></li>
            <li><a href="#">Swift-Strings</a></li>
            <li><a href="#">Swift-Lists</a></li>
            <li><a href="#">Swift-Tuples</a></li>
            <li><a href="#">Swift-Dictionary</a></li>
            <li><a href="#">Swift-Time & Date</a></li>
            <li><a href="#">Swift-Functions</a></li>
            <li><a href="#">Swift-Modules</a></li>
            <li><a href="#">Swift-Files I/O</a></li>
            <h4 class="font-italic">Swift Advanced Tutorials</h4>
            <li><a href="#">Swift-Classes/objects</a></li>
            <li><a href="#">Swift-Databases access</a></li>
            <li><a href="#">Swift-Networking</a></li>
            <li><a href="#">Swift-Sending Email</a></li>
            <li><a href="#">Swift-Multithreading</a></li>
            <li><a href="#">Swift-XML processing</a></li>
            <li><a href="#">Swift-GUI programming</a></li>
          </ol>
        </div>
