  ...
  <main role="main" class="container">
    <div class="row">
      <div class="col-md-8 blog-main" style="border: .5px dotted rgb(230, 226, 226); background-color: rgb(255, 255, 255); margin-top: 20px;">
        ...
        <div class="blog-post">
          <h2 class="blog-post-title" style="text-align: center;">JavaScript-Home</h2>
      ...
      <aside class="col-md-4 blog-sidebar" >
        <div class="p-4" style="border: .5px dotted rgb(235, 227, 227); background-color: rgb(255, 254, 254); margin-top: 20px;">
          ...
          <h4 class="font-italic">JavaScript Basic Tutorials</h4>
          <ol class="list-unstyled mb-0" >
            <li><a href="#">JavaScript-Home</a></li>
            <li><a href="#">JavaScript-Overview</a></li>
            <li><a href="#">JavaScript-setup</a></li>
            <li><a href="#">JavaScript-syntax</a></li>
            <li><a href="#">JavaScript-variable types</a></li>
            <li><a href="#">JavaScript-Basic operator</a></li>
            <li><a href="#">JavaScript-Decision making</a></li>
            <li><a href="#">JavaScript-Loops</a></li>
            <li><a href="#">JavaScript-Numbers</a></li>
            <li><a href="#">JavaScript-Strings</a></li>
            <li><a href="#">JavaScript-Lists</a></li>
            <li><a href="#">JavaScript-Tuples</a></li>
            <li><a href="#">JavaScript-Dictionary</a></li>
            <li><a href="#">JavaScript-Time & Date</a></li>
            <li><a href="#">JavaScript-Functions</a></li>
            <li><a href="#">JavaScript-Modules</a></li>
            <li><a href="#">JavaScript-Files I/O</a></li>
            <h4 class="font-italic">JavaScript Advanced Tutorials</h4>
            <li><a href="#">JavaScript-Classes/objects</a></li>
            <li><a href="#">JavaScript-Databases access</a></li>
            <li><a href="#">JavaScript-Networking</a></li>
            <li><a href="#">JavaScript-Sending Email</a></li>
            <li><a href="#">JavaScript-Multithreading</a></li>
            <li><a href="#">JavaScript-XML processing</a></li>
            <li><a href="#">JavaScripts-GUI programming</a></li>
          </ol>
        </div>
