  ...
  <main role="main" class="container">
    <div class="row">
      <div class="col-md-8 blog-main" style="border: .5px dotted rgb(230, 226, 226); background-color: rgb(255, 255, 255); margin-top: 20px;">
        ...
        <div class="blog-post">
          <h2 class="blog-post-title" style="text-align: center;"></h2>Java-Home</h2>
      ...
      <aside class="col-md-4 blog-sidebar" >
        <div class="p-4" style="border: .5px dotted rgb(235, 227, 227); background-color: rgb(255, 254, 254); margin-top: 20px;">
          ...
          <ol class="list-unstyled mb-0" >
            ...
            <li><a href="#">Java-Tuples</a></li>
            <li><a href="#">Java-Dictionary</a></li>
            <li><a href="#">Java-Time & Date</a></li>
            <li><a href="#">Java-Functions</a></li>
            <li><a href="#">Java-Modules</a></li>
            <li><a href="#">Java-Files I/O</a></li>
            <h4 class="font-italic">Java Advanced Tutorials</h4>
            <li><a href="#">java-Classes/objects</a></li>
            <li><a href="#">java-Databases access</a></li>
            <li><a href="#">java-Networking</a></li>
            <li><a href="#">java-Sending Email</a></li>
            <li><a href="#">java-Multithreading</a></li>
            <li><a href="#">java-XML processing</a></li>
            <li><a href="#">java-GUI programming</a></li>
          </ol>
        </div>
