  ...
  <main role="main" class="container">
    <div class="row">
      <div class="col-md-8 blog-main" style="border: .5px dotted rgb(230, 226, 226); background-color: rgb(255, 255, 255); margin-top: 20px;">
        ...
        <div class="blog-post">
          <h2 class="blog-post-title" style="text-align: center;">Php-Home</h2>
      ...
      <aside class="col-md-4 blog-sidebar">
        <div class="p-4" style="border: .5px dotted rgb(235, 227, 227); background-color: rgb(255, 254, 254); margin-top: 20px;">
          ...
          <h4 class="font-italic">Php Basic Tutorials</h4>
          <ol class="list-unstyled mb-0">
            <li><a href="#">Php-Home</a></li>
            <li><a href="#">Php-Overview</a></li>
            <li><a href="#">Php-setup</a></li>
            <li><a href="#">Php-syntax</a></li>
            <li><a href="#">Php-variable types</a></li>
            <li><a href="#">Php-Basic operator</a></li>
            <li><a href="#">Php-Decision making</a></li>
            <li><a href="#">Php-Loops</a></li>
            <li><a href="#">Php-Numbers</a></li>
            <li><a href="#">Php-Strings</a></li>
            <li><a href="#">Php-Lists</a></li>
            <li><a href="#">Php-Tuples</a></li>
            <li><a href="#">Php-Dictionary</a></li>
            <li><a href="#">Php-Time & Date</a></li>
            <li><a href="#">Php-Functions</a></li>
            <li><a href="#">Php-Modules</a></li>
            <li><a href="#">Php-Files I/O</a></li>
            <h4 class="font-italic">Php Advanced Tutorials</h4>
            <li><a href="#">Php-Classes/objects</a></li>
            <li><a href="#">Php-Databases access</a></li>
            <li><a href="#">Php-Networking</a></li>
            <li><a href="#">Php-Sending Email</a></li>
            <li><a href="#">Php-Multithreading</a></li>
            <li><a href="#">Php-XML processing</a></li>
            <li><a href="#">Php-GUI programming</a></li>
          </ol>
        </div>
