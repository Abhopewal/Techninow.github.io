  ...
  <main role="main" class="container">
    <div class="row">
      <div class="col-md-8 blog-main" style="border: .5px dotted rgb(230, 226, 226); background-color: rgb(255, 255, 255); margin-top: 20px;">
        ...
        <div class="blog-post">
          <h2 class="blog-post-title" style="text-align: center;">Css-Home</h2>
      ...
      <aside class="col-md-4 blog-sidebar">
        <div class="p-4" style="border: .5px dotted rgb(235, 227, 227); background-color: rgb(255, 254, 254); margin-top: 20px;">
          ...
          <h4 class="font-italic">Css Basic Tutorials</h4>
          <ol class="list-unstyled mb-0">
            <li><a href="#">Css-Home</a></li>
            <li><a href="#">Css-Overview</a></li>
            <li><a href="#">Css-setup</a></li>
            <li><a href="#">Css-syntax</a></li>
            <li><a href="#">Css-variable types</a></li>
            <li><a href="#">Css-Basic operator</a></li>
            <li><a href="#">Css-Decision making</a></li>
            <li><a href="#">Css-Loops</a></li>
            <li><a href="#">Css-Numbers</a></li>
            <li><a href="#">Css-Strings</a></li>
            <li><a href="#">Css-Lists</a></li>
            <li><a href="#">Css-Tuples</a></li>
            <li><a href="#">Css-Dictionary</a></li>
            <li><a href="#">Css-Time & Date</a></li>
            <li><a href="#">Css-Functions</a></li>
            <li><a href="#">Css-Modules</a></li>
            <li><a href="#">Css-Files I/O</a></li>
            <h4 class="font-italic">Css Advanced Tutorials</h4>
            <li><a href="#">Css-Classes/objects</a></li>
            <li><a href="#">Css-Databases access</a></li>
            <li><a href="#">Css-Networking</a></li>
            <li><a href="#">Css-Sending Email</a></li>
            <li><a href="#">Css-Multithreading</a></li>
            <li><a href="#">Css-XML processing</a></li>
            <li><a href="#">Css-GUI programming</a></li>
          </ol>
        </div>
