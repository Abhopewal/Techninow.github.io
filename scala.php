  ...
  <main role="main" class="container">
    <div class="row">
      <div class="col-md-8 blog-main" style="border: .5px dotted rgb(230, 226, 226); background-color: rgb(255, 255, 255); margin-top: 20px;">
        ...
        <div class="blog-post">
          <h2 class="blog-post-title" style="text-align: center;">Scala-Home</h2>
      ...
      <aside class="col-md-4 blog-sidebar" >
        <div class="p-4" style="border: .5px dotted rgb(235, 227, 227); background-color: rgb(255, 254, 254); margin-top: 20px;">
          ...
          <h4 class="font-italic">Scala Basic Tutorials</h4>
          <ol class="list-unstyled mb-0" >
            <li><a href="#">Scala-Home</a></li>
            <li><a href="#">Scala-Overview</a></li>
            <li><a href="#">Scala-setup</a></li>
            <li><a href="#">Scala-syntax</a></li>
            <li><a href="#">Scala-variable types</a></li>
            <li><a href="#">Scala-Basic operator</a></li>
            <li><a href="#">Scala-Decision making</a></li>
            <li><a href="#">Scala-Loops</a></li>
            <li><a href="#">Scala-Numbers</a></li>
            <li><a href="#">Scala-Strings</a></li>
            <li><a href="#">Scala-Lists</a></li>
            <li><a href="#">Scala-Tuples</a></li>
            <li><a href="#">Scala-Dictionary</a></li>
            <li><a href="#">Scala-Time & Date</a></li>
            <li><a href="#">Scala-Functions</a></li>
            <li><a href="#">Scala-Modules</a></li>
            <li><a href="#">Scala-Files I/O</a></li>
            <h4 class="font-italic">Scala Advanced Tutorials</h4>
            <li><a href="#">Scala-Classes/objects</a></li>
            <li><a href="#">Scala-Databases access</a></li>
            <li><a href="#">Scala-Networking</a></li>
            <li><a href="#">Scala-Sending Email</a></li>
            <li><a href="#">Scala-Multithreading</a></li>
            <li><a href="#">Scala-XML processing</a></li>
            <li><a href="#">Scala-GUI programming</a></li>
          </ol>
        </div>
