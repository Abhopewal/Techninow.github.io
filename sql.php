  ...
  <main role="main" class="container">
    <div class="row">
      <div class="col-md-8 blog-main" style="border: .5px dotted rgb(230, 226, 226); background-color: rgb(255, 255, 255); margin-top: 20px;">
        ...
        <div class="blog-post">
          <h2 class="blog-post-title" style="text-align: center;">Sql-Home</h2>
      ...
      <aside class="col-md-4 blog-sidebar" >
        <div class="p-4" style="border: .5px dotted rgb(235, 227, 227); background-color: rgb(255, 254, 254); margin-top: 20px;">
          ...
          <h4 class="font-italic">Sql Basic Tutorials</h4>
          <ol class="list-unstyled mb-0" >
            <li><a href="#">Sql-Home</a></li>
            <li><a href="#">Sql-Overview</a></li>
            <li><a href="#">Sql-setup</a></li>
            <li><a href="#">Sql-syntax</a></li>
            <li><a href="#">Sql-variable types</a></li>
            <li><a href="#">Sql-Basic operator</a></li>
            <li><a href="#">Sql-Decision making</a></li>
            <li><a href="#">Sql-Loops</a></li>
            <li><a href="#">Sql-Numbers</a></li>
            <li><a href="#">Sql-Strings</a></li>
            <li><a href="#">Sql-Lists</a></li>
            <li><a href="#">Sql-Tuples</a></li>
            <li><a href="#">Sql-Dictionary</a></li>
            <li><a href="#">Sql-Time & Date</a></li>
            <li><a href="#">Sql-Functions</a></li>
            <li><a href="#">Sql-Modules</a></li>
            <li><a href="#">Sql-Files I/O</a></li>
            <h4 class="font-italic">Sql Advanced Tutorials</h4>
            <li><a href="#">Sql-Classes/objects</a></li>
            <li><a href="#">Sql-Databases access</a></li>
            <li><a href="#">Sql-Networking</a></li>
            <li><a href="#">Sql-Sending Email</a></li>
            <li><a href="#">Sql-Multithreading</a></li>
            <li><a href="#">Sql-XML processing</a></li>
            <li><a href="#">Sql-GUI programming</a></li>
          </ol>
        </div>
